      ...
      <div className="max-w-2xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-6 mt-8">
            <a href="https://linkedin.com/in/harikrishna-alungal-prakas" target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-surface border border-glassBorder text-slate-400 hover:text-blue-400 hover:border-blue-400/50 transition-all shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
            </a>
            <a href="https://github.com/alungalhari" target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-surface border border-glassBorder text-slate-400 hover:text-white hover:border-white/50 transition-all shadow-sm">
